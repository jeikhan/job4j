# Обучающий курс на Java-программиста
### Описание
Проект www.Job4j.ru – это грамотное обучение разработке программного обеспечения.

Автор проекта: Петр Арсентьев ([e-mail](parsentev@yandex.ru))
